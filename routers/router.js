...
exports.doRecording = function (req, res, next) {
    ...
    form.parse(req, function (err, fields) {
        db.getAllCount("article1", function (count) {
            var allCount = count.toString();
            var date = moment(new Date()).format('YYYY-MM-DD HH:mm:ss');
            //写入数据库
            db.insertOne("article1", {
...
exports.getArticle = function (req, res, next) {
    ...
    db.find("article1",{},{"pageamount":10,"page":page,"sort":{"date":-1}}, function (err, result) {
...
exports.showArticle = function (req, res, next) {
    ...
    db.find("article1",{"ID":aId},function (err,result) {
        if(err){
            console.log(err);
        }
        res.render("article",{
...
exports.delArticle =function (req, res, result) {
    ...
    form.parse(req, function (err, fields, files) {
        ...
        db.deleteMany("article1",{"ID":ID},function (err,results) {
            if(err){
...
exports.doLogin = function (req, res, result) {
    ...
    form.parse(req, function(err, fields, files) {
        ...
        db.find("user1",{"username":username},function(err,result){
            if(err){
                res.send("-3");//服务器错误
                return
            }
...
exports.getAddress = function (req, res, result) {
    ...
    form.parse(req, function(err, fields, files) {
        ...
        db.getAllCount("Visitor1", function (count) {
            var allCount = count.toString();
            var date = moment(new Date()).format('YYYY-MM-DD HH:mm:ss');
            //写入数据库
            db.insertOne("Visitor1", {
                "ID" : parseInt(allCount) + 1,
                "ipAddress" : ipAddress,
...
exports.getJavaScript = function (req, res, next) {
    db.find("article1",{"classify":"JavaScript"},{"pageamount":10,"sort":{"date":-1}}, function (err, result) {
        if(err){
            console.log(err);
        }
        var obj = {"allResult" : result};
...
exports.getNodeJS = function (req, res, next) {
    db.find("article1",{"classify":"NodeJS"},{"pageamount":10,"sort":{"date":-1}}, function (err, result) {
        if(err){
            console.log(err);
        }
        var obj = {"allResult" : result};
...
exports.getEnvironment = function (req, res, next) {
    db.find("article1",{"classify":"Environment"},{"pageamount":10,"sort":{"date":-1}}, function (err, result) {
        if(err){
            console.log(err);
        }
        var obj = {"allResult" : result};
...
exports.addVisitorNum = function (req, res, result) {
    ...
    form.parse(req, function(err, fields, files) {
        ...
        db.find("article1",{"ID":aId},function (err,result) {
            ...
            var ID = result[0].ID;
            db.updateMany("article1",{"ID":ID},{$set:{"visitNum":visitNum+1}},function (err,results) {
                if(err){
...
exports.addThumbsUp = function (req,res,result) {
    ...
    form.parse(req, function(err, fields, files) {
        ...
        db.find("article1",{"ID":aId},function (err,result) {
            ...
            var ID = result[0].ID;
            db.updateMany("article1",{"ID":ID},{$set:{"thumbsUp":thumbsUp+1}},function (err,results) {
                if(err){
